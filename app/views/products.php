...
if (isset($_GET['editprod'])){
    ...
    if (isset($_POST['edititemname'])) {
        ...
        $sql = "UPDATE hardware_products SET `productname` = '$itemname', description = '$itemdescription', categoryid = $itemcat, 
                quantity = $itemquantity, price = $itemprice, updated_at = NOW() WHERE id = $itemid";
